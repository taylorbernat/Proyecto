...
<html>
    ...
    <body>
                    ...
                    <table id="tablaContenido">
                        ...
                        <tbody id="contentGenTable">
                            <tr class="rowToble">
                                ...
                                <td><select name="NombreProducto" type="text" value="1113" class="contentTable NombresProductos" >
                                        <option value="Amphora Bolso Monique">Amphora Bolso Monique</option>
                                        <option value="Studio F Bolso Mini Croco">Studio F Bolso Mini Croco</option>
                                        <option value="Totto Morral Crayola">Totto Morral Crayola   </option>
                                    </select>
                                </td>
        ...
        <script src="Interacciones/SalidaProductos.js"></script>
    </body>
